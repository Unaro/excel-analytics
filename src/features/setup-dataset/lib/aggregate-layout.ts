...
import type { AggregateNode, EmptyConfig, AggregateLayoutConfig, AggregateTemplateSpec } from '@/shared/lib/types/aggregate';
...
export type { EmptyConfig, AggregateLayoutConfig, AggregateTemplateSpec };
