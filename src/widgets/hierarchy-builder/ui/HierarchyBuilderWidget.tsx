...
export function HierarchyBuilderWidget() {
  return (
    <ClientOnly fallback={<LoadingScreen message="Загрузка настройки иерархии..." />}>
      <HierarchyBuilderContent />
    </ClientOnly>
  );
}

function HierarchyBuilderContent() {
  return (
    <div className="p-8 max-w-6xl mx-auto space-y-8">
      <div>
        ...
        <p className="text-slate-500 dark:text-slate-400 mt-2 max-w-3xl">
          Определите структуру вложенности данных (например:{' '}
          ...
          <span className="text-xs opacity-70 mt-1 block">
            * В список попадают только колонки, отмеченные как{' '}
            <strong>Категория</strong> в разделе настройки данных.
          </span>
        </p>
      </div>
