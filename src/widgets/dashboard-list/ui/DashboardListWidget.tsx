...
export function DashboardListWidget() {
  return (
    <ClientOnly fallback={<LoadingScreen message="Загрузка списка дашбордов..." />}>
...
function DashboardListContent() {
  ...
  const { deleteId, isConfirming, requestDelete, cancelDelete, confirmDelete } = useDeleteDashboard();
                  ...
                  <div className="flex justify-between items-start">
                    ...
                    <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                      ...
                      <Button
                        ...
                        onClick={() => requestDelete(dashboard.id)}
                      >
                        <Trash2 size={16} />
                      </Button>
                    </div>
