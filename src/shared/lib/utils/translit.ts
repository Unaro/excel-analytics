...
/**
 * Транслитерирует кириллицу в безопасный латинский идентификатор:
 * нижний регистр, пробелы/дефисы → «_», прочие символы удаляются.
 * Используется для генерации алиасов колонок из русских заголовков.
 */
