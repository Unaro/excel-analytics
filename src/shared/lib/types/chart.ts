...
export type ChartType =
    ...
    | 'treemap';  // Treemap — доли категорий по одной метрике
...
/** Метрика рисуется столбцом, линией или областью (filled line). */
...
export interface MetricChartStyle {
  ...
  /** Для line/area: тип кривой. По умолчанию 'smooth'. */
  curve?: LineCurve;
  /** Для line/area: штрих обводки. По умолчанию 'solid'. */
  dash?: LineDash;
}
