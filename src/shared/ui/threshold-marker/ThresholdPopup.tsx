    ...
    <Popover.Root open={open}>
      ...
      <Popover.Portal>
        <Popover.Content
          ...
          className={cn(
            'w-[340px] bg-white/95 dark:bg-slate-900/95 backdrop-blur-md text-slate-900 dark:text-white',
            'rounded-xl shadow-2xl border border-slate-200 dark:border-slate-700/50',
            'overflow-hidden ring-1 ring-black/5 dark:ring-black/20',
        ...
        >
          {/* Заголовок */}
          <div className="px-4 py-3 border-b border-slate-200 dark:border-slate-700/50 bg-gradient-to-r from-slate-50 to-white dark:from-slate-800/80 dark:to-slate-800/40">
            ...
            {rules.map((entry, i) => {
              ...
              return (
                <div
                  ...
                  className="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800/70 transition-colors"
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="text-sm font-medium text-slate-700 dark:text-slate-100 truncate leading-tight">
                      {entry.metricName}
                    </div>
          ...
          {/* Футер */}
          <div className="px-4 py-2 border-t border-slate-200 dark:border-slate-700/50 bg-slate-50 dark:bg-slate-800/30 flex items-center justify-between">
          ...
          <Popover.Arrow className="fill-white/95 dark:fill-slate-900/95" />
        </Popover.Content>
      </Popover.Portal>
    </Popover.Root>,
    document.body
